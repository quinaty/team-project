                            ...
                            case "class":
                                return {
                                    ...
                                    teacher:
                                        teachers[
                                            Math.floor(
                                                Math.random() * teachers.length
                                            )
                                        ],
                                    classes: (() => {
                                        const classCount =
                                            Math.floor(Math.random() * 2) + 1; // 1-2个班级
                                        const grade =
                                            Math.floor(Math.random() * 4) + 1; // 1-4年级
                                        return Array.from(
                                            {length: classCount},
                                            () =>
                                                `计算机${grade}年${String.fromCharCode(
                                                    65 +
                                                        Math.floor(
                                                            Math.random() * 3
                                                        )
